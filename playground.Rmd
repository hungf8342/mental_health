...
loc.toUse<-logtable_full_crop_normalized[part,]
ggplot(loc.toUse,aes(x=socialRec,y=log(suicides)))+geom_point()+
  geom_label_repel(aes(fill=facility_cnt>.4,label=logtable_full[part,][["location"]]),fontface = 'bold',     color = 'black', box.padding = 0.5, point.padding = 1, segment.color = 'grey50')+
