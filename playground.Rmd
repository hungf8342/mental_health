...
# filtered_facs has exactly the same number of observations as facilities so I don't think the preceding three lines of code are necessary. Also it puts the generic long/lat for the zipcode while the original facilities has the specific long lat for the facility. 
